        ...
        <div class="card-body">
            <form action="../../routing/routing.php" method="post">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="email" name="email" class="form-control h-25" placeholder="<?= $_SESSION['prof']['Email']?>">
                </div>

                <div class="form-group mb-4">
                    <label>Numero de Telephone</label>
                    <input type="text" name="numero" class="form-control h-25" placeholder="<?= "0".$_SESSION['prof']['Tel']?>">
                </div>
                ...
                <input type="submit" name="compteProf" class="btn btn-success mb-4" id="bouton" value="changer mes donnees" >
