        ...
        <div class="card-body">
            <form action="../../routing/routing.php" method="post">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="email" name="email" class="form-control h-25" placeholder="<?= $_SESSION['etd']['Email']?>">
                </div>

                <div class="form-group mb-4">
                    <label>Numero de Telephone</label>
                    <input type="text" name="numero" class="form-control h-25" placeholder="<?= "0".$_SESSION['etd']['Tel']?>">
                </div>
                ...
                <input type="submit" name="compteEtudiant" class="btn btn-primary mb-4" value="changer mes donnees" >
