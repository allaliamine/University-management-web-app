...
<body id="page-top">
    ...
    <div id="wrapper" >
        ...
        <div class="container-fluid offset-2 px-0 col-md-10 col-sm-9">
            ...
            <!-- Les filiers -->
            <br>
            <form action="publier_note.php" method="POST">
                <h3 class="choice" style="top: 100px;">Veuillez Choisir l'option que vous voulez : </h3>
                <div class="filiere">
                <?php
                require '../includes/note_view.inc.php';
                 $module=show_module();
                ?>
            </form>
            <div class="module">
                <h3>Choisissez le module :</h3>
                <div class="semestre">
                <?php if(isset($module) && !empty($module)) : ?>
                <form action="../includes/note_cont.inc.php" method="POST" enctype="multipart/form-data">
                <?php foreach($module as $modules) : ?>
                    <div class="choix">
                        <input type="radio" name="module" value="<?= htmlspecialchars($modules['Intitule']) ?>">
                        <span><?= htmlspecialchars($modules['Intitule']) ?></span>
                        <br>
                    </div>
                <?php endforeach ?>
                <input type="submit" class="bouton" name="Submit" value="Submit">
                </form>
                <?php else : ?>
